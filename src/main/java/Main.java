...
public class Main {
    ...
    public void init() throws IOException {
       ...
       //finish line
        ...
        objectBotol.get(0).scaleObject(0.7f,0.7f,0.7f);
        objectBotol.get(0).translateObject(0.0f, 0.5f, 0f);
        ...
        objectBotol.get(1).translateObject(0.0f, 0.8f, 0f);
    }
